...
var focus = "cazicthule"
var zoneID = 123

// Menu represents the cazicthule menu options
func Menu(opt wmenu.Opt) (err error) {
	...
	ok = true
	fmt.Println("This tool creates a new zone to represent old cazicthule with zone id", zoneID)
